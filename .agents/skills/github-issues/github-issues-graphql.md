# GitHub GraphQL reference (on demand)

Read only when the task needs queries/mutations beyond the CLI. Issues API preferred; ProjectV2 for board fields — see [projectv2.md](projectv2.md).
